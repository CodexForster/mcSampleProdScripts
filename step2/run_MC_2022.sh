...
### NANOAOD step
echo "********** NANOAOD start **********"
cmsDriver.py --python_filename nanoAOD_cfg.py --eventcontent NANOAODSIM --datatier NANOAODSIM --conditions 126X_mcRun3_2022_realistic_v2 --step NANO --nThreads 4 --scenario pp --era Run3,run3_nanoAOD_124  --filein file:zh_hto2w_zto2l_miniAOD.root --fileout file:zh_hto2w_zto2l_nanoAOD.root --no_exec --mc -n 5000
...
xrdcp -f ${FINAL_FILE_NAME} root://eosuser.cern.ch//eos/user/d/dshekar/MCsims_ZH3l/mcSample_ZH_HWW_Z2L_centralSampleGridpack/${FINAL_FILE_NAME}

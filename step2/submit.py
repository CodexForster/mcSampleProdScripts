...
def main():
    ...
    for i in range(num_nodes):
        ...
        f.write("executable              = run_MC_2022.sh \n")
        ...
        f.write("transfer_input_files  = /afs/cern.ch/user/d/dshekar/private/mcSamples/powheg/HIG-Run3Summer22wmLHEGS-02385-fragment.py, $(Proxy_path), /afs/cern.ch/user/d/dshekar/private/mcSamples/powheg/ZH_HWW_Z2L_centralSample/step2/update_paths.py\n")

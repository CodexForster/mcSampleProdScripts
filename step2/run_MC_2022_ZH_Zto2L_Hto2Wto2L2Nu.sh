...
mv ${BASEDIR}/HIG-Run3Summer22wmLHEGS-ZH_Zto2L_Hto2Wto2L2Nu-fragment.py Configuration/GenProduction/python/
scram b
SEED=$((${1} + ${2}))
echo "Seed set to: ${SEED}"
cmsDriver.py Configuration/GenProduction/python/HIG-Run3Summer22wmLHEGS-ZH_Zto2L_Hto2Wto2L2Nu-fragment.py --era Run3 --customise Configuration/DataProcessing/Utils.addMonitoring --beamspot Realistic25ns13p6TeVEarly2022Collision --step LHE,GEN,SIM --geometry DB:Extended --conditions 124X_mcRun3_2022_realistic_v12 --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed="int(${SEED})"\\nprocess.source.numberEventsInLuminosityBlock="cms.untracked.uint32(100)" --datatier GEN-SIM,LHE --eventcontent RAWSIM,LHE --python_filename wmLHEGS_cfg.py --fileout file:zh_hto2wto2l2nu_zto2l_LHEGS.root --mc --no_exec -n 500
...
eval `scram runtime -sh`
mv ../../CMSSW_12_4_25/src/zh_hto2wto2l2nu_zto2l_AOD.root ./
### MINIAOD step
echo "********** MINIAOD start **********"
cmsDriver.py --python_filename miniAOD_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --conditions 130X_mcRun3_2022_realistic_v5 --step PAT --nThreads 2 --geometry DB:Extended --era Run3,run3_miniAOD_12X --filein file:zh_hto2wto2l2nu_zto2l_AOD.root --fileout file:zh_hto2wto2l2nu_zto2l_miniAOD.root --no_exec --mc -n 500
cmsRun miniAOD_cfg.py
echo "********** MINIAOD End **********"

### NANOAOD step
echo "********** NANOAOD start **********"
cmsDriver.py --python_filename nanoAOD_cfg.py --eventcontent NANOEDMAODSIM --datatier NANOAODSIM --conditions 130X_mcRun3_2022_realistic_v5 --step NANO --nThreads 4 --scenario pp --era Run3  --filein file:zh_hto2wto2l2nu_zto2l_miniAOD.root --fileout file:zh_hto2wto2l2nu_zto2l_nanoAOD.root --no_exec --mc -n 500
cmsRun nanoAOD_cfg.py
echo "********** NANOAOD End **********"

FINAL_FILE_NAME="nanoAOD_${CLUSTER_ID}_${PROC_ID}.root"
mv zh_hto2wto2l2nu_zto2l_nanoAOD.root ${FINAL_FILE_NAME}

# Copy the renamed file to the destination
xrdcp -f ${FINAL_FILE_NAME} root://eosuser.cern.ch//eos/user/d/dshekar/MCsamplesForBDTzh3l/mcSample_ZH_Zto2L_Hto2Wto2L2Nu_centralSampleGridpack/${FINAL_FILE_NAME}

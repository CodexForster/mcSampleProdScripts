...
jobName = 'RAWSIM_cfg_test0'
# Can resubmit or check status/report/log/output of crab job with 'crab resubmit/status/report/getlog/getoutput crabRAWSIMsample/RAWSIM_cfg_test0
config.General.requestName = jobName
config.General.workArea = 'crabRAWSIMsample'
...
# config.JobType.allowUndistributedCMSSW = True # Don't know what this means (DS, 26Jan26)

config.section_("Data")
config.Data.outputPrimaryDataset = jobName
config.Data.outLFNDirBase = '/store/user/dshekar/'
config.Data.splitting = 'EventBased'
config.Data.unitsPerJob = 50 # Each job generates 'unitsPerJob' number of events? (DS, 26Jan26)
NJOBS = 5 # This is not a configuration parameter, but an auxiliary variable that we use in the next line.
config.Data.totalUnits = config.Data.unitsPerJob * NJOBS # Total number of events generated/simulated? (DS, 26Jan26)
config.Data.publication = True
config.Data.outputDatasetTag = 'CRAB3_RAWSIM_generation_test0'

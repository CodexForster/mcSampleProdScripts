...
jobName = 'DRPremix_cfg_test0'
# Can resubmit or check status/report/log/output of crab job with 'crab resubmit/status/report/getlog/getoutput crabDRPremixsample/DRPremix_cfg_test0
config.General.requestName = jobName
config.General.workArea = 'crabDRPremixsample'
# config.General.workArea = '/afs/cern.ch/user/d/dshekar/private/mcSamples/powheg/ZH_HWW_Z2L_centralSample_crab/DRPremix_CMSSW_12_4_25/CMSSW_12_4_25/src/'

config.section_("JobType")
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = 'DRPremix_cfg.py'
...
config.Data.outputDatasetTag = 'CRAB3_DRPremix_generation_test0'
